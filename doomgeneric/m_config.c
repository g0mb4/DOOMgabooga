...
void M_LoadDefaults (void)
{
    ...
    if (i)
    {
        ...
        printf("        extra configuration file: %cs\n", 
...
{
    char *result = alloc(get_heap_allocator(), 2);
    result[0] = '.';
    result[1] = '\0';
...
void M_SetConfigDir(char *dir)
{
    ...
    {
        printf("Using %cs for configuration and saves\n", configdir);
    }
